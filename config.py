...
# build_heat.py writes only to PROCESSED_DATA_DIR; the graphics-rig embed consumes
# the published GeoJSON, so presentation can change without touching fetch/reformat.
